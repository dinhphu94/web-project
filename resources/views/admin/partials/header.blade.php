	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="{{URL::to('admin/dashboard')}}" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="{{URL::to('admin/dashboard')}}"><i class="fa fa-navicon"></i></a></li>			
			</ul>
	        ...
	        <ul class="nav navbar-nav navbar-right">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="{{Asset('admin/assets/img/avatar1.jpg')}}">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="{{Asset('admin/assets/img/avatar2.jpg')}}">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="{{Asset('admin/assets/img/avatar3.jpg')}}">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="{{Asset('admin/assets/img/avatar4.jpg')}}">
								<div>New message</div>
						...
						<li class="avatar">
							<a href="page-inbox.html">
								<img class="avatar" src="{{Asset('admin/assets/img/avatar5.jpg')}}">
								<div>New message</div>
				...
				<li class="dropdown visible-md visible-lg">
	        		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img class="user-avatar" src="{{Asset('admin/assets/img/avatar.jpg')}}" alt="user-mail">dinhphu94@gmail.com</a>
	        		<ul class="dropdown-menu">
						<li class="dropdown-menu-header">
				...
				<li><a href="{{URL::to('auth/logout')}}"><i class="fa fa-power-off"></i></a></li>
			</ul>
